...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO XYLAW SCRIPT ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
...
wget -q https://raw.githubusercontent.com/Xyr3760/tunnel/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
